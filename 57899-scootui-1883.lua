...
local Library do
    ...
    local Components = { } do
        ...
        Components.WindowPage = function(self, Data)
            ...
            function Page:Turn(Bool)
                ...
                for Index, Value in AllInstances do 
                    ...
                    if type(TransparencyProperty) == "table" then 
                        for _, Property in TransparencyProperty do 
                            NewTween = Tween:FadeItem(Value, Property, not Bool, Data.Window.FadeTime)
                        end
                    else
                        NewTween = Tween:FadeItem(Value, TransparencyProperty, not Bool, Data.Window.FadeTime)
                    end
                end
        ...
        Components.Toggle = function(self, Data)
            ...
            local Items = { } do
                ...
                Items["SubElements"] = Instances:Create("Frame", {
                    ...
                    BorderColor3 = FromRGB(0, 0, 0),
                    BackgroundTransparency = 1,
                    Posit...(truncated 149396 characters)...
                })  
            end
        ...
        -- (Seluruh definisi Components lainnya seperti Slider, Dropdown, Label, dll. -- tambahkan dari script asli yang terpotong)
    ...
    Library.InventoryViewer = function(self)
        ...
        Library.Window = function(self, Data)
            -- (Seluruh definisi Window, Page, Section, dll. -- tambahkan dari script asli)
        ...
        -- (Seluruh definisi Library.Page, Library.Sections, dll. -- tambahkan dari script asli)
...
end  -- <--- Ini akhir dari blok 'local Components = { } do ... end'
